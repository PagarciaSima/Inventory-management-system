...
public class CategoryRestController {
	 ...
	 *
	 * @return ResponseEntity<CategoryResponseRest> An HTTP response containing the
	 *         list of categories.
	 */
	 ...
	 * 
	 * @param category The category object to be saved, provided in the request
	 *                 body.
	 * @return ResponseEntity containing the response with the saved category and
	 *         metadata indicating the success of the operation. If the category is
	 *         successfully saved, a 200 OK response will be returned. If the
	 *         category is not saved (for example, due to validation errors), a 400
	 ...
	 * @param id       The ID of the category to be updated, provided as a path
	 *                 variable.
	 * @return ResponseEntity containing the response with the updated category and
	 *         metadata indicating the success of the operation. If the category is
	 *         successfully updated, a 200 OK response will be returned. If the
	 *         category is not found, a 404 Not Found response will be returned. If
	 *         the category is not updated (for example, due to validation errors),
	 ...
	 * @return ResponseEntity containing the response with metadata indicating the
	 *         success of the operation. If the category is successfully deleted, a
	 *         200 OK response will be returned. If the category is not found, a 404
	 *         Not Found response will be returned. If an error occurs during the
	 *         deletion process, a 500 Internal Server Error response will be
	 *         returned.
	 */
	...
	public void exportToExcel(HttpServletResponse response) throws IOException {
		...
		ResponseEntity<CategoryResponseRest> categoryResponse = iCategoryService.search();
